...
import * as strings from 'PdfConvertAndDownloadCommandSetStrings';
import ConvertOrDownloadDialog from './components/ConvertOrDownloadDialog';
  ...
  public onExecute(event: IListViewCommandSetExecuteEventParameters): void {
    switch (event.itemId) {
      case 'CONVERT':
        ...
        const dialog: ConvertOrDownloadDialog = new ConvertOrDownloadDialog();
        dialog.show();
        break;
      case 'DOWNLOAD':
